# Purpose: Campaign Registry + Partner Asset Pages

This area documents how Cambermast manages campaigns and partner-facing asset pages.
...
- Render partner-friendly pages that show production links and downloadable QR assets.
