<script lang="ts">
	...
	type CampaignView = ReturnType<typeof listCampaigns>[number] & {
	...
	const toCampaignView = (campaign: ReturnType<typeof listCampaigns>[number]): CampaignView => {
		const category: CampaignCategory = campaign.landingPath.startsWith('/events/') ? 'event' : 'landing';
		...
		return {
			...
			trackingUrlProd: `${prodOrigin}${trackingPath}`
		};
	};

	const baseCampaigns = listCampaigns();
					...
					{#each activeCampaigns as campaign}
						...
						>
							<div class="flex flex-wrap items-start justify-between gap-4">
								...
								<p class="mt-2 flex flex-wrap items-center gap-2 text-sm text-gray-700">
									...
									<span class="rounded-full bg-gray-100 px-2 py-0.5 font-mono text-xs text-gray-800">
										{campaign.id}
									</span>
									{#if campaign.partner}
						...
						<div class="mt-5 grid gap-5">
							<div class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
								<p class="text-xs font-semibold tracking-wide text-gray-500 uppercase">Primary URLs</p>
							...
							<details class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
								<summary class="cursor-pointer text-xs font-semibold tracking-wide text-gray-500 uppercase">
									Advanced details
								</summary>
										...
										<div class="mt-2 space-y-2">
											<div class="space-y-1">
												...
												<div class="flex items-center gap-2">
													<code class="rounded bg-white px-2 py-1 text-[11px] break-all text-gray-800">
							...
							<div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
								<div class="flex flex-wrap items-center justify-between gap-3">
									<div>
										...
										<p class="mt-1 text-xs text-gray-600">Pre-generated for active campaigns.</p>
									</div>
									<div class="flex flex-wrap gap-2">
										<button
											type="button"
													...
													{#if qrAssets[campaign.id]?.prod?.svgDataUrl}
														<div>
															...
															<div class="mt-2 grid grid-cols-2 gap-2">
																...
																<span class="hidden min-w-[140px] sm:inline-flex" aria-hidden="true"></span>
															</div>
														</div>
													{/if}
												</div>
								...
								<div class="flex flex-wrap items-start justify-between gap-4">
									...
									<p class="mt-2 flex flex-wrap items-center gap-2 text-sm text-gray-700">
										...
										<div class="mt-3 flex flex-wrap gap-2 text-xs text-gray-600">
											...
											<span class="rounded-full bg-white px-2 py-1">Landing: {campaign.landingPath}</span>
											<span class="rounded-full bg-white px-2 py-1">Created: {campaign.createdAt}</span>
									</div>
								</div>
								...
								<div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
									<div class="flex flex-wrap items-center justify-between gap-3">
										<div>
											...
											<p class="mt-1 text-xs text-gray-600">Generated on demand for archived campaigns.</p>
										</div>
										<div class="flex flex-wrap gap-2">
											<button
												type="button"
