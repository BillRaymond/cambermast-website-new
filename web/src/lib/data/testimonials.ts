 ...
 *
 * n8n (or another workflow) can regenerate this module whenever new, approved
 * testimonials are ready. Each entry ties back to a training SKU so that both
 * the public training pages and TechLAB pages can render the same quotes.
 */
